...
* @{
*/
#define PRODUCT_KEY "19f827520f4d4f31a0f58f323346167c"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "cfaca47f84be49519cdc2cfbc15eaeff"
...
#define Ultraviolet_index_RATIO                         1
#define Ultraviolet_index_ADDITION                      0
#define Ultraviolet_index_MIN                           0
#define Ultraviolet_index_MAX                           11
#define temp_value_RATIO                         1
#define temp_value_ADDITION                      -80
#define temp_value_MIN                           30
#define temp_value_MAX                           130
#define humidity_value_RATIO                         1
#define humidity_value_ADDITION                      0
#define humidity_value_MIN                           0
#define humidity_value_MAX                           100
#define light_intensity_RATIO                         1
#define light_intensity_ADDITION                      0
#define light_intensity_MIN                           0
#define light_intensity_MAX                           20000
#define air_pressure_RATIO                         1
#define air_pressure_ADDITION                      0
#define air_pressure_MIN                           0
#define air_pressure_MAX                           200000
/**@} */
...
typedef struct {
  uint32_t valueUltraviolet_index;
  int32_t valuetemp_value;
  uint32_t valuehumidity_value;
  uint32_t valuelight_intensity;
  uint32_t valueair_pressure;
} dataPoint_t;
...
typedef struct {
  uint8_t valueUltraviolet_index;
  uint8_t valuetemp_value;
  uint8_t valuehumidity_value;
  uint16_t valuelight_intensity;
  uint32_t valueair_pressure;
} devStatus_t; 
